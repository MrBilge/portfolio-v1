    ...
    <div className="flex h-screen w-full justify-between bg-[url('/assets/bilge.png')] bg-no-repeat px-20 py-10  bg-center ">
      <div className="flex flex-col gap-10 w-1/2 mt-20 space-y-5">
        ...
        <div className="space-y-10">
          ...
          <p className="text-lg  font-serif text-gray-400 tracking-widest">
        ...
        <div
          ...
          className="w-max p-10 bg-blue-600 cursor-pointer transition-all duration-300 hover:scale-75"
        >
          <ChevronDownIcon className="h-9 w-9 animate-bounce-large" />
        </div>
      </div>
      ...
      <div className="text-xs flex flex-col space-y-20 w-1/3 mt-20">
        <div className="space-y-2">
          ...
          <div className="group flex mt-5 ">
            <p className="text-lg cursor-pointer border-b border-gray-500 transition-all duration-600  group-hover:border-white ">
              LEARN MORE
            </p>
            <span>
        ...
        <div className="flex flex-col space-y-2">
          ...
          <div className="group flex space-x-2 mt-5 ">
            <p className="text-lg cursor-pointer border-b border-gray-500 transition-all duration-700 group-hover:border-white">
              BROWSE PORTFOLIO
            </p>
            <span>
              <ArrowRightIcon className="inline w-6 h-6 ml-2 transition-all duration-300 group-hover:ml-5" />
        ...
        <div className="space-y-2">
          ...
          <div className="flex w-max space-x-3 group">
            <Facebook className="w-6 h-6 transition-all duration-300 group-hover:opacity-40 hover:opacity-100 hover:scale-110 hover:translate-y-2 cursor-pointer" />
            <Instagram className="w-6 h-6 transition-all duration-300 group-hover:opacity-40 hover:opacity-100 hover:scale-110 hover:translate-y-2 cursor-pointer" />
            <Github className="w-6 h-6 transition-all duration-300 group-hover:opacity-40 hover:opacity-100 hover:scale-110 hover:translate-y-2 cursor-pointer" />
            <Youtube className="w-6 h-6 transition-all duration-300 group-hover:opacity-40 hover:opacity-100 hover:scale-110 hover:translate-y-2 cursor-pointer" />
            <Linkedin className="w-6 h-6 transition-all duration-300 group-hover:opacity-40 hover:opacity-100 hover:scale-110 hover:translate-y-2 cursor-pointer" />
          </div>
        </div>
      </div>
    </div>
